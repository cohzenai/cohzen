"""Anthropic Claude LLM call and tools detector."""
...
class AnthropicDetector:
    """Detects Anthropic messages create calls and tool bindings."""
    ...
    def detect_call(self, call: ast.Call, file_path: str, lineno: int) -> Optional[LLMCallSite]:
        ...
        if "messages.create" in func_str or "anthropic.completions" in func_str:
            model_name = None
            tools_list: List[str] = []
