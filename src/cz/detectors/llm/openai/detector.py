"""OpenAI LLM call and tools detector."""
...
class OpenAIDetector:
    """Detects OpenAI chat completions and tools bindings."""
    ...
    def detect_call(self, call: ast.Call, file_path: str, lineno: int) -> Optional[LLMCallSite]:
        ...
        if "chat.completions.create" in func_str or "completions.create" in func_str:
            model_name = None
            tools_list: List[str] = []
            ...
            for kw in call.keywords:
                ...
                elif kw.arg in ("tools", "functions"):
